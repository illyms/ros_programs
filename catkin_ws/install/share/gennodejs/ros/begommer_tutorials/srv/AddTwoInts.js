...
// (in-package begommer_tutorials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'begommer_tutorials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'begommer_tutorials/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'begommer_tutorials/AddTwoInts'; }
};
